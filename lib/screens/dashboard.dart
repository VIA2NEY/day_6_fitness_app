    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
            ...
            child: CircleAvatar(
              backgroundImage: ExactAssetImage('assets/two.jpg'),
            ),
          ),
        actions: <Widget>[
          Padding(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  children: [
                    makeItem(image: "assets/two.jpg", title: "Full Body\nExercise"),
                    makeItem(image: "assets/three.jpg", title: "Chest Muscle\nExercise"),
                    makeItem(image: "assets/one.jpg", title: "Full Body\nExercise"),
                  ],
                )
              ],
            ),
